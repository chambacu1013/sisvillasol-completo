...
CREATE TABLE sisvillasol.insumos (
    ...
    stock_minimo DECIMAL(10,2) DEFAULT 5, -- Para la Alerta
...
('Manzana Anna','Malus domestica', 100), ('Ciruela Horvin','Prunus domestica', 120),
...
('Mantenimiento General Finca','No Aplica',0);
